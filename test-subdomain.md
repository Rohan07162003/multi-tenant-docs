...
# Version 1 (legacy)
127.0.0.1 acme-corp.v1.localhost
127.0.0.1 techflow-solutions.v1.localhost
127.0.0.1 globaldyne-industries.v1.localhost

# Version 2 (latest) - explicit version
127.0.0.1 acme-corp.v2.localhost
127.0.0.1 techflow-solutions.v2.localhost
127.0.0.1 globaldyne-industries.v2.localhost
```
...
- `http://acme-corp.localhost:3000/docs` - Shows only Acme Corp v2.0 content (latest)
- `http://techflow-solutions.localhost:3000/docs` - Shows only TechFlow Solutions v2.0 content (latest)
- `http://globaldyne-industries.localhost:3000/docs` - Shows only GlobalDyne Industries v2.0 content (latest)

#### Client-Specific Documentation (Version 1 - Legacy)
- `http://acme-corp.v1.localhost:3000/docs` - Shows only Acme Corp v1.0 content (legacy)
- `http://techflow-solutions.v1.localhost:3000/docs` - Shows only TechFlow Solutions v1.0 content (legacy)
- `http://globaldyne-industries.v1.localhost:3000/docs` - Shows only GlobalDyne Industries v1.0 content (legacy)

#### Client-Specific Documentation (Version 2 - Explicit Latest)
- `http://acme-corp.v2.localhost:3000/docs` - Shows only Acme Corp v2.0 content (explicit latest)
- `http://techflow-solutions.v2.localhost:3000/docs` - Shows only TechFlow Solutions v2.0 content (explicit latest)
- `http://globaldyne-industries.v2.localhost:3000/docs` - Shows only GlobalDyne Industries v2.0 content (explicit latest)
...
- `https://acme-corp.yourdomain.com/docs` → Shows v2.0 content
- `https://techflow-solutions.yourdomain.com/docs` → Shows v2.0 content
- `https://globaldyne-industries.yourdomain.com/docs` → Shows v2.0 content

### Specific Versions
- `https://acme-corp.v1.yourdomain.com/docs` → Shows v1.0 content
- `https://acme-corp.v2.yourdomain.com/docs` → Shows v2.0 content
- `https://techflow-solutions.v1.yourdomain.com/docs` → Shows v1.0 content
- `https://techflow-solutions.v2.yourdomain.com/docs` → Shows v2.0 content
...
3. **URL Transformation**: URLs are transformed to remove the client and version prefixes:
   - `/acme-corp/v1/production-systems` becomes `/production-systems` on `acme-corp.v1.domain`
   - `/acme-corp/v2/api-reference` becomes `/api-reference` on `acme-corp.domain`
